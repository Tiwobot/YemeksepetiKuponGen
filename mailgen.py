...
class MailGenerator():
    def generateAndSet():
        ...
        yemeksepeti_mail.yemeksepetiAccountMailSetter()

        WebDriverWait(driver, 240).until(EC.presence_of_element_located((By.XPATH, "//*[@id=\"email-table\"]/div[2]/div[4]/div[3]/center/div[2]/table/tbody/tr[3]/td/table/tbody/tr[3]/th/a"))).click()
